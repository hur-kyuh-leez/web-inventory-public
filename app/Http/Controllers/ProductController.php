...
//        $products = Product::paginate(25);
        ...
        $products = Product::orderBy('sorting_order','asc')->paginate(999); // show all


        $received_products = ReceivedProduct::all(); // show all

        return view('inventory.products.index', compact('products','received_products'));
    }
