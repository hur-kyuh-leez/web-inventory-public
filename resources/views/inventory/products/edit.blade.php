@extends('layouts.app', ['page' => __('Edit Product'), 'pageSlug' => 'products', 'section' => 'inventory'])
                                ...
                                <div class="row" hidden>
                                    <div class="col-4">
                                        <div class="form-group{{ $errors->has('stock') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="stock" id="input-stock" class="form-control form-control-alternative" placeholder="Stock" value="{{ old('stock', $product->receiveds->sum('stock') - $product->solds->sum('qty')) }}" required>
