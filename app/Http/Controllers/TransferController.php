...
class TransferController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(TransferRequest $request, Transfer $transfer, Transaction $transaction)
    {
        ...
        return redirect()
            ...
            ->withStatus(__('Transaction registered successfully.'));
    }
    ...
    public function destroy(Transfer $transfer)
    {
        ...
        return back()
            ->withStatus(__('The transfer and its associated transactions have been successfully removed.'));
    }
}
