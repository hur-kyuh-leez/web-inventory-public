@extends('layouts.app', ['page' => __('Edit Income'), 'pageSlug' => 'incomes', 'section' => 'transactions'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Edit Income') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('transactions.update', $transaction) }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Income Information') }}</h6>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group{{ $errors->has('selected_date') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="selected_date" id="datepicker" class="datepicker-selector form-control form-control-alternative{{ $errors->has('selected_date') ? ' is-invalid' : '' }}" placeholder="{{ __('Date') }}" value="{{ old('selected_date', $transaction->selected_date ?? date('Y-m-d', strtotime($transaction->created_at))) }}" required>
