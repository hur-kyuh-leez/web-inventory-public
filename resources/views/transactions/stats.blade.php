@extends('layouts.app', ['pageSlug' => 'tstats', 'page' => __('Statistics'), 'section' => 'transactions'])
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{  __('Transaction Statistics') }}</h4>
                        </div>
        ...
        <div class="col-md-6">
            <div class="card card-tasks">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{  __('Pending Balances') }}</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('clients.index') }}" class="btn btn-sm btn-primary">{{  __('View Clients') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($clients as $client)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('clients.transactions.add', $client) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="{{  __('Register Transation') }}">
                                                <i class="tim-icons icon-simple-add"></i>
                                            </a>
                                            <a href="{{ route('clients.show', $client) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="{{  __('See Client') }}">
        ...
        <div class="col-md-6">
            <div class="card card-tasks">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">{{  __('Statistics by Methods') }}</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('methods.index') }}" class="btn btn-sm btn-primary">{{  __('View Methods') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-full-width table-responsive">
                        <table class="table">
                            <thead>
                                <th>{{  __('Method') }}</th>
                                <th>{{  __('Transactions') }} {{ $date->year }}</th>
                                <th>{{  __('Balance') }} {{ $date->year }}</th>
                                <th></th>
                            </thead>
                            <tbody>
                                @foreach($methods as $method)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('methods.show', $method) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="{{ __('See Method') }}">
                                                <i class="tim-icons icon-zoom-split"></i>
                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('sales.index') }}" class="btn btn-sm btn-primary">{{  __('View Sales') }}</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        ...
                        <th data-toggle="tooltip" data-placement="bottom" title="{{  __('Average Income per Sale') }}">{{  __('Average C / V') }}</th>
                        <th>{{  __('Billed Amount') }}</th>
                        <th>{{  __('To Finalize') }}</th>
                    </thead>
                    <tbody>
