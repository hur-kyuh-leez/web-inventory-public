@extends('layouts.app', ['page' => __('Product Information'), 'pageSlug' => 'products', 'section' => 'inventory'])
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($solds as $sold)
                                <tr>
                                    <td>{{ date('Y-m-d', strtotime($sold->created_at)) }}</td>
                                    ...
                                    <td class="td-actions text-right">
                                        <a href="{{ route('sales.show', $sold->sale_id) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="{{ __('View Sale') }}">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($receiveds as $received)
                                <tr>
                                    <td>{{ date('Y-m-d', strtotime($received->created_at)) }}</td>
                                    ...
                                    <td class="td-actions text-right">
                                        <a href="{{ route('receipts.show', $received->receipt) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="{{ __('More Details') }}">
                                            <i class="tim-icons icon-zoom-split"></i>
                                        </a>
                                    </td>
                                </tr>
